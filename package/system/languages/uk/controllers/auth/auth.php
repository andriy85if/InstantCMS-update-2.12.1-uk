...
define('LANG_REG_CFG_NOTIFY_OLD_AUTH', 'Показувати попередження про зміну пароля');
define('LANG_REG_CFG_NOTIFY_OLD_AUTH_HINT', 'Для користувачів, зареєстрованих до версії InstantCMS 2.12.1, щоб перейти на <a target="_blank" href="https://docs.instantcms.ru/manual/components/auth#вкладка-авторизация">нову систему зберігання паролів</a>.');
...
define('LANG_AUTH_IS_OLD_AUTH', 'Ви давно не змінювали пароль, можна <a href="%s">зробити це зараз</a>.');
